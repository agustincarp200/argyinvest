  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <TextInput style={styles.input} placeholder="Email" placeholderTextColor={theme.gray}
          value={email} onChangeText={setEmail} keyboardType="email-address" autoCapitalize="none" />
        <TextInput style={styles.input} placeholder="Contraseña" placeholderTextColor={theme.gray}
...
const getStyles = (theme: any) => StyleSheet.create({
  container: { flex: 1, backgroundColor: theme.bg, justifyContent: 'space-between', padding: 24 },
  ...
  footer: { color: theme.gray, textAlign: 'center', fontSize: 11, paddingBottom: 10 },
});